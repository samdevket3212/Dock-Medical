      ...
      <div className='max-w-dcContainer mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-16 mb-32'>
          <div className='dc__ImgDiv block w-full z-10 relative'>
            <img
              src='/assets/images/allergyImg1.jpg'
        ...
        <div className='dc__Info w-full block mb-24'>
          <div className='dc__Title flex items-center jsutify-center flex-col text-center'>
            ...
            <h4 className='text-dcBlack100 font-medium text-dcH4 md:text-dcH2 mb-10'>
              Addressing the Symptoms of Allergies with dock.
            </h4>
            <p className='text-black font-light text-left text-dcBody3 md:text-dcBody1 w-full md:w-3/5'>
              For mild and moderate symptoms, dock. is here to provide allergy
              treatment for a variety of allergies including:For mild and
              moderate symptoms, dock. is here to provide allergy treatment for
              a variety of allergies including:
            </p>
            <ul className='text-black text-left font-light text-dcBody3 md:text-dcBody2 w-full md:w-3/5 pl-3'>
              <li className='w-full list-inside list-disc mb-3'>
                Seasonal Allergies: Allergies may suddenly arise during the
                spring and summer months as seasonal allergy triggers are spread
                out further and in greater abundance than normal. Thankfully,
                dock. can help address the symptoms of seasonal allergies
                including sneezing, itchy and watery eyes, congestion,
                sniffling, coughing, and related seasonal allergy symptoms.
              </li>
              <li className='w-full list-inside list-disc'>
                Sudden allergic reactions: Patients that have long-term
                allergies and mild symptoms can also visit dock. for treatment.
                Symptoms including skin rashes, hives, and other irritations can
                be treated right here at our facilities.
              </li>
            </ul>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              <div className='block w-full'>
                <h2 className='relative text-dcBlack100 text-dcH4 md:text-dcH2 font-medium mb-5'>
                  Specialized Care for Your Allergy Symptoms with dock.
                  <div className='flex items-center gap-x-1.5 mt-5'>
                    <span className='w-3 h-3 bg-dcBlue50 rounded-full' />
                    <span className='w-3 h-3 bg-dcYellow400 rounded-full' />
                    <span className='w-3 h-3 bg-dcGreen50 rounded-full' />
                ...
                <div className='dc__FluContent flex flex-col justify-center bg-dcBlue50 p-10'>
                  <p className='text-black font-light text-dcBody3 md:text-dcBody1'>
                    dock. treats a variety of allergy symptoms as well as
                    hereditary and environmental allergy symptoms including:
                  </p>
                  <ul className='w-full list-disc font-light text-dcBody3 md:text-dcBody1 my-5'>
                    <li className='w-full list-inside list-disc'>Sneezing</li>
                    <li className='w-full list-inside list-disc'>Hives</li>
                    <li className='w-full list-inside list-disc'>Coughing</li>
                    <li className='w-full list-inside list-disc'>Congestion</li>
                    <li className='w-full list-inside list-disc'>
                      Sore Throat
                    </li>
                    <li className='w-full list-inside list-disc'>
                    ...
                    <li className='w-full list-inside list-disc'>Puffy Eyes</li>
                    <li className='w-full list-inside list-disc'>And More</li>
                  </ul>
                </div>
              </div>
              <div className='dc__FluImgDiv'>
                <img
                  src='/assets/images/allergyImg2.jpg'
                  alt='StrepThroatImg'
                  className='w-full h-auto mb-10'
                />
                <p className='text-black font-normal text-dcBody3 md:text-dcBody1 w-11/12 ml-auto'>
                  If you think you are suffering from allergies, come give us a
                  visit.
                </p>
                <button className='bg-dcGreen400 w-auto px-8 py-2 rounded-md text-dcBody2 flex items-center my-10 text-white'>
                  Book Now

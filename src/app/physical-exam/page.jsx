...
import { physicalExamArr } from "@/helpers/helper";
      ...
      <div className="max-w-dcContainer mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-32">
          <div className="dc__ImgDiv block w-full z-10 relative">
            <img
              src="/assets/images/physicalExamImg.jpg"
          ...
          <div className="w-full dc__ContentDiv">
            ...
            <p className="text-black text-dcBody1">
              ...
              provides first-rate physical therapy in a modern and luxurious
              environment. Whether you are suffering from chronic pains or
              recovering from an on-the-job injury, your highly trained dock.
              physical therapy team is here to help restore your functional
              capacity!{" "}
            </p>
        ...
        <div className="dc__Info w-full block mb-24">
          <div className="dc__Title flex items-center jsutify-center flex-col text-center">
            ...
            <p className="text-black font-light text-dcBody1 w-3/5">
              {`The future of your healthcare isn’t based on illness or injury.
              It’s not based on immediate or ongoing. It is based on customized,
              continuous, and comprehensive care.`}
            </p>
          </div>
        </div>
      </div>
      <div className="block w-full dc__SliderOuterDiv mb-24">
        <h4 className="text-dcBlack100 text-dcBody2 font-medium mb-8">
          we provide
        </h4>
        <Slider {...settings}>
          {physicalExamArr?.map((slide) => (
            <div
            ...
            >
              <img
                src={`/assets/svgs/physicalExam/Icon${slide?.id}.svg`}
                alt="Icon"
